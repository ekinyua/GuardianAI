...
public class LocationSharing extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void sendDistressSignal() {
        if (currentLocation != null) {
            ...
            String distressMessage = "Hello, this is my distress signal. I might be in danger, here is my current location: http://maps.google.com/maps?q="
            ...
            executorService.execute(() -> {
                ...
                try {
                    ...
                    // Only add phone_number if the emergency contact is available
                    if (emergencyContact != null && !emergencyContact.isEmpty()) {
                        jsonParam.put("phone_number", "whatsapp:"+ emergencyContact);
                    }
